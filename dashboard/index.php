...
<head>
    ...
    <link rel="stylesheet" href="../dashboard/assets/css/bootstrap-select.less">
...
<?php include 'home.php'; ?>
  ...
  <script src="../dashboard/assets/js/lib/chart-js/Chart.bundle.js"></script>
  <script src="../dashboard/assets/js/dashboard.js"></script>
  <script src="../dashboard/assets/js/widgets.js"></script>
  <script src="../dashboard/assets/js/lib/vector-map/jquery.vmap.js"></script>
  <script src="../dashboard/assets/js/lib/vector-map/jquery.vmap.min.js"></script>
  <script src="../dashboard/assets/js/lib/vector-map/jquery.vmap.sampledata.js"></script>
  <script src="../dashboard/assets/js/lib/vector-map/country/jquery.vmap.world.js"></script>
  <script>
      ( function ( $ ) {
          "use strict";
