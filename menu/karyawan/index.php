                            ...
                            <table style="width:100%" class="table table-striped">
                              <thead>
                                <tr>
                                  ...
                                  <th scope="col"><a href="../module/content.php?module=add-employee" class="btn btn-success btn-xs">Add Data</a></th>
                                </tr>
                              </thead>
                              <tbody>
                              <!--  <tr>
	     ...
	     //while($res = mysqli_fetch_array($result)) {
          ...
          $number +=1;
	         ...
	         echo "<td>".$res['phone']."</td>";
					 echo "<td> <a href='../module/content.php?module=edit-employee&id=$res[id]' class='btn btn-primary btn-sm'>Edit </a>|<a href='../menu/karyawan/delete.php?id=$res[id]' onClick=\"return confirm('Are you sure you want to delete?')\" class='btn btn-danger btn-sm'>Delete </a></td>";
	     }
	     ?>
<!--edit.php?id=$res[id]-->
