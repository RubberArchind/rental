...
if(isset($_POST['update']))
{
    ...
    if($msg) {
        ...
        //updating the table
        $result = $crud->execute("UPDATE customer SET ktp='$ktp',name='$name',address='$address',phone='$phone' WHERE id=$id");

        //redirectig to the display page. In our case, it is index.php
      header("Location:../module/content.php?module=customer&msg=success-update");
    }
}
?>
<!DOCTYPE html>
		...
		<div class="wrap-contact100">
			<form method="post" action="" class="contact100-form validate-form">
				...
				<div class="wrap-input100 validate-input" data-validate="NIK is required">
					<input class="input100" type="text" maxlength="16" onkeypress="return hanyaAngka(event, false)" name="ktp" placeholder="NIK/NO KTP (Angka 16 digit)" value="<?php echo $ktp;?>">
